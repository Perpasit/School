        ...
        while(option!=5){
            ...
            switch(option){
                case 1:
                    ...
                    System.out.println("b is bachelor students, m is master students, and  p is Ph.D.students.");
                    System.out.print("Enter your Degree: ");
                    String degree=input.next();
                    if(degree.equals("b")||degree.equals("B")){
                        degree="bachelor";
                    }
                    if(degree.equals("m")||degree.equals("M")){
                        degree="master";
                    }
                    if(degree.equals("p")||degree.equals("P")){
                        degree="Ph.D.";
                    }
                    System.out.println(" ");
